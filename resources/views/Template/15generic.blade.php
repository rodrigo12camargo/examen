		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<h1>T15 Ventajas y desventajas de la arquitectura cliente servidor</h1>
							<span class="image main"></span>
                            <h2>Ventajas</h2>
							<p>Como ya habrás deducido, el modelo cliente/servidor está especialmente indicado en redes medias o grandes que necesiten un alto nivel de fiabilidad.
