						...
						<div class="inner">
							...
							<!-- Logo -->
								<a href="{{('inicio')}}" class="logo">
									<span class="symbol"><img src="images/logo.svg" alt="" /></span><span class="title">Examen 1U</span>
								</a>
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<section class="tiles">
								<article class="style1">
									...
									<a href="{{('01generic')}}">
										<h2>Conceptos de Sistemas de información</h2>
										<div class="content">
											<p></p>
										</div>
									</a>
								...
								<article class="style2">
									...
									<a href="{{('02generic')}}">
										<h2>Evolucion de los sistemas de información</h2>
										<div class="content">
											<p></p>
										</div>
									</a>
								...
								<article class="style5">
									...
									<a href="{{('05generic')}}">
										<h2>Conceptos de sistemas de conexión libre y atraves de redes</h2>
										<div class="content">
											<p></p>
										</div>
									</a>
								...
								<article class="style3">
									...
									<a href="{{('08generic')}}">
										<h2>Clasificacion de los sistemas de acuerdo a su arquitectura</h2>
										<div class="content">
											<p></p>
										</div>
									</a>
								...
								<article class="style1">
									...
									<a href="{{('09generic')}}">
										<h2>Proceso de diagramacion de la arquitectura Cliente/Servidor</h2>
										<div class="content">
											<p></p>
										</div>
									</a>
								...
								<article class="style6">
									...
									<a href="{{('11generic')}}">
										<h2>Conceptos de programa maestro</h2>
										<div class="content">
											<p></p>
										</div>
									</a>
								...
								<article class="style2">
									...
									<a href="{{('14generic')}}">
										<h2>Caracteristicas de la arquitectura Cliente/Servidor</h2>
										<div class="content">
											<p></p>
										</div>
									</a>
								...
								<article class="style3">
									...
									<<a href="{{('15generic')}}">
										<h2>Ventajas y desventajas de la arquitectua Cliente/Servidor</h2>
										<div class="content">
											<p></p>
										</div>
									</a>
								...
								<article class="style4">
									...
									<a href="{{('16generic')}}">
										<h2>Conceptos de computo en la nube</h2>
										<div class="content">
											<p></p>
										</div>
									</a>
								...
								<article class="style5">
									...
									<a href="{{('17generic')}}">
										<h2>Conceptos de IAAS, BAAS, ISAAS</h2>
										<div class="content">
											<p></p>
										</div>
									</a>
								...
								<article class="style1">
									...
									<a href="{{('34generic')}}">
										<h2>Proceso del uso de stockets </h2>
										<div class="content">
											<p></p>
										</div>
									</a>
								...
								<article class="style3">
									...
									<a href="{{('35generic')}}">
										<h2>Proceso del uso de stockets en aplicaciones</h2>
										<div class="content">
											<p></p>
										</div>
									</a>
