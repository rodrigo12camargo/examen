		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<h1>T33 Definir el concepto de sockets.</h1>
							<span class="image main"></span>
							<p>Un socket en programación es un tunel de comunicación que ayuda a que 2 aplicaciones se comuniquen, los sockets son la base de internet y de sus protocolos como HTTP, FTP, SMTP, etc.</p>
