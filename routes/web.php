...
route::get('/19generic', function () {
    return view('Template.19generic');
})->name('19generic');


route::get('/20generic', function () {
    return view('Template.20generic');
})->name('20generic');

route::get('/21generic', function () {
    return view('Template.21generic');
})->name('21generic');

route::get('/22generic', function () {
    return view('Template.22generic');
})->name('22generic');

route::get('/23generic', function () {
    return view('Template.23generic');
})->name('23generic');

route::get('/24generic', function () {
    return view('Template.24generic');
})->name('24generic');

route::get('/25generic', function () {
    return view('Template.25generic');
})->name('25generic');

route::get('/26generic', function () {
    return view('Template.26generic');
})->name('26generic');

route::get('/27generic', function () {
    return view('Template.27generic');
})->name('27generic');

route::get('/28generic', function () {
    return view('Template.28generic');
})->name('28generic');

route::get('/29generic', function () {
    return view('Template.29generic');
})->name('29generic');

route::get('/30generic', function () {
    return view('Template.30generic');
})->name('30generic');

route::get('/31generic', function () {
    return view('Template.31generic');
})->name('31generic');

route::get('/32generic', function () {
    return view('Template.32generic');
})->name('32generic');

route::get('/33generic', function () {
    return view('Template.33generic');
})->name('33generic');

route::get('/34generic', function () {
    return view('Template.34generic');
})->name('34generic');

route::get('/35generic', function () {
    return view('Template.35generic');
})->name('35generic');